...
StringGrid1.Cells[1,0] := 'Имя поля';
StringGrid1.Cells[2,0] := 'Тип поля';
StringGrid1.Cells[3,0] := 'Длина/Значение';
StringGrid1.Cells[4,0] := 'Разрешить NULL';
...
begin
Form3.Caption := 'Создать таблицу: "' + Memo2.Text + '"';
end;
